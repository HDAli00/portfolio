...
const TECHS: { name: string; icon: React.ReactNode }[] = [
  { name: 'Kubernetes', icon: <BrandIcon icon={siKubernetes} /> },
  { name: 'OpenTelemetry', icon: <BrandIcon icon={siOpentelemetry} /> },
  { name: 'Python', icon: <BrandIcon icon={siPython} /> },
  { name: 'Docker', icon: <BrandIcon icon={siDocker} /> },
  { name: 'Terraform', icon: <BrandIcon icon={siTerraform} /> },
  { name: 'AWS', icon: <DeviconIcon path={AWS_PATH} color="#FF9900" /> },
  { name: 'Azure', icon: <DeviconIcon path={AZURE_PATH} color="#0078D4" /> },
  { name: 'Grafana', icon: <BrandIcon icon={siGrafana} /> },
  { name: 'Spark', icon: <BrandIcon icon={siApachespark} /> },
  { name: 'Ansible', icon: <BrandIcon icon={siAnsible} /> },
  { name: 'GitHub Actions', icon: <BrandIcon icon={siGithubactions} /> },
  { name: 'Helm', icon: <BrandIcon icon={siHelm} /> },
]
